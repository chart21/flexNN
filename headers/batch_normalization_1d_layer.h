...
namespace simple_nn
{
	...
	{
        std::cout << "PARTY " << PARTY <<  ": Batchnorm (1D) forward ..." << std::endl;
    ...
    std::cout << "PARTY " << PARTY <<  ": Time Batchnorm (1D): " << double(std::chrono::duration_cast<std::chrono::microseconds>( r2 - r1 ).count())/1000000 << std::endl;
