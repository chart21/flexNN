...
void Config::print_help()
{
    ...
    std::cout << "  --activ         = Activation function for hidden layer (options: tanh, relu; default: relu)"
              << std::endl;
    std::cout << "  --init          = Weight initialization (default: lecun_uniform)" << std::endl;
    std::cout << "                    (options: lecun_uniform, lecun_normal, xavier_uniform, xavier_normal, "
                 "kaiming_uniform, kaiming_normal)"
              << std::endl;
    std::cout << "  --loss          = Loss function for training (options: cross_entropy, mse; default: cross_entropy)"
              << std::endl;
...
void Config::check_if_args_valid()
{
    ...
    if (init != "normal" && init != "uniform" && init != "lecun_normal" && init != "lecun_uniform" &&
        init != "xavier_normal" && init != "xavier_uniform" && init != "kaiming_normal" && init != "kaiming_uniform")
    {
